class Flower {
    ...
    // Function to create a flower in the future, we will use this function to create multiple flowers with different properties
 constructor(x,y,size,stemLength,petalColor) {
    ...
    let self = this; // Store a reference to the current instance of the Flower class
